...
const artworksData = [
  {
    ...
    process: 'Started with rough character sketches, developed the pose and anatomy, then built up the background elements. The lighting was carefully crafted to create dramatic contrast and emphasize the character\'s powerful presence.',
  ...
  },
  {
    ...
    process: 'Began with concept sketches exploring different poses and expressions. Refined the character design through multiple iterations, focusing on costume details and personality expression. The background was designed to complement the character without overwhelming the focal point.',
    inspiration: 'Inspired by fantasy character archetypes and the desire to create a strong, memorable original character.',
  ...
  },
  {
    ...
    description: 'Angel middle finger to heavens - a bold statement piece',
    ...
    process: 'Conceptualized as a commentary on religious iconography, executed with careful attention to symbolic elements.',
  ...
  },
  {
    ...
    process: 'Character concept developed through exploration of celestial and outlaw archetypes.',
    inspiration: '',
  ...
  },
  {
    ...
    year: '2024',
    software: 'Krita',
    tags: ['Character Design', 'Fantasy', 'Subversive', 'Digital Art'],
    thumbnailUrl: '/assets/art/damsel.png',
    imageUrl: '/assets/art/damsel.png',
    process: 'Designed to challenge traditional fantasy character tropes while maintaining visual appeal.',
    inspiration: '',
    techniques: ['Character Design', 'Fantasy Art', 'Digital Painting'],
  },
  {
    ...
    process: 'Created as practice pieces for environmental design and atmospheric rendering.',
  ...
  },
  {
    ...
    process: 'Developed with focus on cold color palettes and atmospheric effects.',
  ...
  },
  {
    ...
    process: 'Character and environment designed to emphasize themes of solitude and duty.',
